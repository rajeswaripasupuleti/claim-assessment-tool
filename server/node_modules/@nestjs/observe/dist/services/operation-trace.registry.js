...
import { collapseRepeatedSpans, DEFAULT_SPAN_COLLAPSE, } from "./collapse-repeated-spans.util.js";
...
export class OperationTraceRegistry {
     ...
     */
    spanCollapse = DEFAULT_SPAN_COLLAPSE;
    /**
     ...
     */
    configureSpanCollapse(settings) {
    ...
    async pluckSnapshot(traceId) {
        ...
        if (snapshot) {
            ...
            if (this.spanCollapse) {
                snapshot.traces = collapseRepeatedSpans(snapshot.traces, this.spanCollapse);
            }
            return snapshot;
        }
        return undefined;

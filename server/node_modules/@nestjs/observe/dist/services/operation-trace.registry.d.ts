...
import { SpanCollapseSettings } from "./collapse-repeated-spans.util.js";
type TraceId = string;
export declare class OperationTraceRegistry {
    ...
    startTrace(traceId: TraceId, data: Omit<RequestSnapshot, "traces" | "startTimestamp" | "calledAt" | "traceId"> | Omit<JobSnapshot, "duration">, 
    /**
